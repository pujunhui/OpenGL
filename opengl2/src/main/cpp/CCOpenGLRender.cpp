...
void Java_com_pujh_opengl_CCGLRender3_ndkInitGL(JNIEnv *env, jobject obj, jobject assetManager) {
...
void Java_com_pujh_opengl_CCGLRender3_ndkPaintGL(JNIEnv *env, jobject obj) {
    m_ndkGLESRender.PaintGL();
}

void
Java_com_pujh_opengl_CCGLRender3_ndkResizeGL(JNIEnv *env, jobject obj, jint width, jint height) {
